...
<body class="curbody">
	...
	<form name="form2">
		...
		<logic:notEmpty name="olmsgList">
					...
					<tr>
						<td style='cursor: move; white-space: nowrap;' width='100%'
							...
							<div style="float: right; width: 80px; text-align: right; padding-right: 7px;">
								...
								<a style='cursor: pointer;' title="删除" onclick="msgdel('ff8080813d00613e013d0067909e0009')">
									<img src="${ctx}/images/olmsg/doc_del.gif" /></a>
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td background="${ctx}/images/olmsg/FFE7E82.gif">
							<div class="msgcontent">
								本系统实现货运企业日常管理<br /> 包括合同、报运、装箱、委托、发票等业务 aa
							</div>
			...
			<div id='ff8080813d00613e013d00681494000b'
				style='position: absolute; left: 742px; top: 91px; z-index: 1002; height: 164px; background: none;'
				onmousedown='getFocus(this)'>
				<table border=0 cellspacing="0" cellpadding="0" width="220">
					<tr>
						<td style='cursor: move;'
							onmousedown="MDown(this,'ff8080813d00613e013d00681494000b')"
							background="${ctx}/images/olmsg/FFE0FB1.gif" height="45"><input
							type="hidden" name="id" class="input"
							value="ff8080813d00613e013d00681494000b" /> <input type="hidden"
							name="isChange" class="input" value="0" /> <input type="hidden"
							name="posX" class="input" value="442" /> <input type="hidden"
							name="posY" class="input" value="91" /> &nbsp;</td>
					</tr>
					<tr>
						<td style='cursor: move; white-space: nowrap;' width='100%'
							onmousedown="MDown('ff8080813d00613e013d00681494000b')"
							background="${ctx}/images/olmsg/FFE0FB2.gif">
							<div
								style="float: left; width: 130px; padding-left: 7px; font-family: Tahoma; color: gray; font-style: oblique;">
								2013-02-22 13:37</div>
							<div
								style="float: right; width: 80px; text-align: right; padding-right: 7px;">
								<a style='cursor: pointer;' title="编辑"
									onclick="msgupdate('ff8080813d00613e013d00681494000b','edit')"><img
									src="${ctx}/images/olmsg/doc_edit.gif" /></a> <a
									style='cursor: pointer;' title="删除"
									onclick="msgdel('ff8080813d00613e013d00681494000b')"><img
									src="${ctx}/images/olmsg/doc_del.gif" /></a>
					...
					<tr>
						<td background="${ctx}/images/olmsg/FFE0FB2.gif">
							<div class="msgcontent">
								ssnsnsnnsns<br /> hahahahahahha


						</td>
					</tr>
					<tr>
						<td id="tagBPic" background="${ctx}/images/olmsg/FFE0FB3.gif"
							height="63">
							<table border="0" width="100%" cellspacing="0" cellpadding="0">
								<tr>
									<td width="50" align="center"><img border="0"
